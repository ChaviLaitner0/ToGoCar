...
namespace Dal
{
        ...
        public DalManger()
    {
        ...
        services.AddDbContext<BridalContext>(options => options.UseSqlServer("Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\user1\\Desktop\\פרויקט\\Data\\MyDataBase.mdf;Integrated Security=True;Connect Timeout=30;Encrypt=True"));
